...
public class BookController {
    ...
    @Autowired
    public void setLibraryController(LibraryRepository libraryRepository) {
    ...
    @GetMapping("/deleteBook/{id}/{library_id}")
    ...
    @GetMapping("/deleteBookSecond/{id}")
    public String deleteSecondBook(
            @PathVariable(name = "id") int bookId) {
